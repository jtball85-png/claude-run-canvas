# -*- coding: utf-8 -*-
"""One-off targeted update of Business Math (course 456) Day 2 reading pages,
per Josh's feedback (2026-09-09): same visual rebuild as Day 1, applied to
the 8 four-operations reading pages (addition/subtraction/multiplication/
division). Only these 8 pages' body HTML changes -- worksheets, Unit 1
Quiz/Test, and Day 2 Overview/Want More Practice? are untouched.

Source of truth for the new bodies is the sibling repo's
day2-module-fragment.json (Master Business Finance Program), read directly
here so nothing gets retyped/out of sync.

Uses targeted PUTs against already-live Pages (matched by url slug), same
pattern as update_business_math_day1_visual_readings.py -- never
push_course.py's delete-and-rebuild path.
"""
import json
import os
import sys
...
FRAGMENT_PATH = (
    ...
    r"\day2-module-fragment.json"
)

SLUG_BY_TITLE = {
    "Addition with Carrying — Reading": "addition-with-carrying-reading",
    "Addition of More Than Two Numbers — Reading": "addition-of-more-than-two-numbers-reading",
    "Subtraction with Regrouping — Reading": "subtraction-with-regrouping-reading",
    "Regrouping with Zeros — Reading": "regrouping-with-zeros-reading",
    "Multiplication with Carrying — Reading": "multiplication-with-carrying-reading",
    "Division by One Digit — Reading": "division-by-one-digit-reading",
    "Division with Remainders — Reading": "division-with-remainders-reading",
    "Division by Larger Numbers — Reading": "division-by-larger-numbers-reading",
}
