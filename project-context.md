...
## What's next
- [ ] Josh reviewing full 10-chapter Computer Basics build in Canvas sandbox (course 301), including the rebuilt Chapter 1 with real Hands-On steps
...
- [ ] As Josh captures real textbook pages for Chapters 2-10 (same photo/screenshot process used for Chapter 1), rebuild each chapter's Page and Skill Builder assignment the same way
